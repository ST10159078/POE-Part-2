...
~How to launch the program open Visual Studio. select "Open a project or solution" under the get started heading on the right side of the screen. loctate the file and click open.

~how the program works This is a recipe application which allows the user to enter ingredients, steps on how to use the ingredients, scaling up the Quantity, warns user if calories ecxeeds 300, printing reciept, and clearing all information.
